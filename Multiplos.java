...
public static void main(String[] args) {
		...
		for (int mult2 = 0; mult2<101; mult2++) { //Se empieza a contar desde el 0 hasta que el numero obtenido sea menor de 101, que seria el 100, sumando 1 en cada iteracion del bucle
		...
		for (int mult3 = 0; mult3<101; mult3++) { //Se empieza a contar desde el 0 hasta que el numero obtenido sea menor de 101, que seria el 100, sumando 1 en cada iteracion del bucle
		numerosMultiplo3 = mult3 * 3; //A cada numero obtenido entre el 0 y el 100 se multiplica por 3 para solo tener multiplos de 3 y estos numeros llegarian hasta el 300
		...
		for (int comunes = 0; comunes<101; comunes++) {
